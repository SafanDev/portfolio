...
export const skills: Skill[] = [
  ...
  { name: "PDO", icon: "pdo", color: "#8892BF", category: "Backend" },
  ...
  { name: ".NET Framework", icon: "dotnet", color: "#512BD4", category: "Desktop" },
  { name: "Windows Forms", icon: "windows", color: "#0078D6", category: "Desktop" },
